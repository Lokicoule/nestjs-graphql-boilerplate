...
import { CustomerCriteria } from '../../domain/criterias/customer.criteria';
import { CustomerCriteriaBuilder } from '../../domain/criterias/customer.criteria.builder';
...
export class CustomerMapper {
  ...
  public static mapCriteriaInputToCriteria(
    ...
    if (customerCriteria?.id) {
      criteriaBuilder.withId(customerCriteria.id);
    }
    if (customerCriteria?.code) {
      criteriaBuilder.withCode(customerCriteria.code);
    }
